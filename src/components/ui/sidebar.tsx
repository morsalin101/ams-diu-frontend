  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          "bg-sidebar text-sidebar-foreground flex h-full w-80 flex-col",
          className,
        )}
        {...props}
      >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-80 bg-white transition-[width] duration-200 ease-linear",
      ...
      >
        <div
          ...
          className="bg-white border-r-2 border-indigo-200 flex h-full w-full flex-col group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
